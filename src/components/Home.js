                        ...
                        <tr>
                            ...
                            <th scope="col">First Name <span className="dropdown">
                                ...
                                <ul className="dropdown-menu">
                                    <li><button className="dropdown-item" onClick={unsort}>Unsort</button></li>
                                    <li><button className="dropdown-item" onClick={sortAZ}>Sort A-Z</button></li>
                                    <li><button className="dropdown-item" onClick={sortZA}>Sort Z-A</button></li>
                                </ul>
                            </span></th>
